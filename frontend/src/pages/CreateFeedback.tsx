          ...
          <Card title="Template Details">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              {/* min-w-0 overrides the grid item's default min-width: auto,
                  and max-w-[180px] is what actually makes this narrower —
                  a fixed cap on this field alone, not a ratio shared with
                  Feedback Cycle Name, so resizing this never touches that
                  field's own width again. */}
